...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn("sh -c 'alacritty --working-directory \"$(xcwd)\"'") end,
              {description = "open alacritty on current path", group = "launcher"}),
